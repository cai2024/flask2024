...
class WGBSForm_custom(MappingCheckForm):
    ...
    dup_soft = SelectField('选择比对软件',choices=["picard","bwa"],validate_choice=False, validators=[DataRequired()],default="picard")
    dup_params =  StringField('dup额外参数设置', validators=[Optional(), Length(min=0, max=50)], default="")    
